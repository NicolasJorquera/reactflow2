...
const arrivalSteps = (steps, duracionPrueba) => {
...
const createVisitas = (visitas, visitasGlobales, nodes, nodeID) => {
...
function checkFinish(visitas, leaves, errores, filtrados, concurrencia, cola, tiempoRespuesta, nodes) {
    let offset = 0;
...
const weightNodes = (root, nodes, edges) => {
    let suma = 0;
